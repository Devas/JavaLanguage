 ...
 * It has some interesting use cases and it's specialized collection for Enumeration types.
 * Using Enum with EnumSet will give you far better performance than using Enum with HashSet, or LinkedHashSet.
 */
